...
# customerlist = [{'name': 'Shashi Kant Singh', 'mobnumber': '1',\
# 				 'mailid': '1', 'password': '1', 'roomnumber' : '1',\
# 				 'checkin' : 'checkin', '2020/9/18' : '2020/9/20',\
# 				  'voterid' : '1234', 'days' : '4', 'totalcharges' : '2000'}]
customerlist =[]
			...
			if roomlist[room] ==0:
				...
				if flag == 3:
					...
					userdata = {'name' : name, 'mailid' : mailid, 'password' : password,\
								'mobnumber' : mobnumber, 'roomnumber' : roomnumber,\
								'checkin' : checkin, 'checkout' : checkout,\
								 'voterid' : voterid, 'days' : days, 'totalcharges' : totalcharges}
					customerlist.append(userdata)
					return render_template('roombook.html', output=userdata)
			else:
				pass
		if flag==0:
